...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompanySearchEngine'
        db.create_table('contact_companysearchengine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('contact', ['CompanySearchEngine'])


    def backwards(self, orm):

        # Deleting model 'CompanySearchEngine'
        db.delete_table('contact_companysearchengine')
    ...
    models = {
        ...
        'contact.companysearchengine': {
            'Meta': {'object_name': 'CompanySearchEngine'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'contact.phonenumber': {
            'Meta': {'ordering': "['-default', 'type']", 'object_name': 'PhoneNumber', '_ormbases': ['core.OwnedObject']},
