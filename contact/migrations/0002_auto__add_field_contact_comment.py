...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.comment'
        db.add_column('contact_contact', 'comment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.comment'
        db.delete_column('contact_contact', 'comment')
