...
class Notification(models.Model):
    ...
    notify_forum_answers = models.BooleanField(default=True, verbose_name=_('Notify forum answers'), help_text=_('You will receive an email when a user posts a new message in a topic in which you participated'))
