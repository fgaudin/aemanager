...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InvoiceRow.balance_payments'
        db.add_column('project_invoicerow', 'balance_payments', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'InvoiceRow.balance_payments'
        db.delete_column('project_invoicerow', 'balance_payments')
