...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.contract_file'
        db.add_column('project_contract', 'contract_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'Contract.content'
        db.alter_column('project_contract', 'content', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Contract.contract_file'
        db.delete_column('project_contract', 'contract_file')

        # User chose to not deal with backwards NULL issues for 'Contract.content'
        raise RuntimeError("Cannot reverse this migration. 'Contract.content' and its values cannot be restored.")
