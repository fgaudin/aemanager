...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Update amount with quantity and unit price
        """
        for proposal_row in orm.ProposalRow.objects.all():
            proposal_row.amount = proposal_row.quantity * proposal_row.unit_price
            proposal_row.save()

        for invoice_row in orm.InvoiceRow.objects.all():
            invoice_row.amount = invoice_row.quantity * invoice_row.unit_price
            invoice_row.save()
