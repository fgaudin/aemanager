...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proposal.expiration_date'
        db.add_column('project_proposal', 'expiration_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Proposal.expiration_date'
        db.delete_column('project_proposal', 'expiration_date')
