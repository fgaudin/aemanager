...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InvoiceRow.proposal'
        db.add_column('project_invoicerow', 'proposal', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='invoice_rows', to=orm['project.Proposal']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'InvoiceRow.proposal'
        db.delete_column('project_invoicerow', 'proposal_id')
