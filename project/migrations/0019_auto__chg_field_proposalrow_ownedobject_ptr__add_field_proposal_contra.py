...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProposalRow.ownedobject_ptr'
        db.alter_column('project_proposalrow', 'ownedobject_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.OwnedObject'], unique=True, primary_key=True))

        # Adding field 'Proposal.contract_file'
        db.add_column('project_proposal', 'contract_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'ProposalRow.ownedobject_ptr'
        db.alter_column('project_proposalrow', 'ownedobject_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.OwnedObject'], unique=True))

        # Deleting field 'Proposal.contract_file'
        db.delete_column('project_proposal', 'contract_file')
