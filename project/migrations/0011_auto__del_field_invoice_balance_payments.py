...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Invoice.balance_payments'
        db.delete_column('project_invoice', 'balance_payments')


    def backwards(self, orm):

        # Adding field 'Invoice.balance_payments'
        db.add_column('project_invoice', 'balance_payments', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
