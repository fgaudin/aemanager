...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Invoice.proposal'
        db.delete_column('project_invoice', 'proposal_id')


    def backwards(self, orm):

        # We cannot add back in field 'Invoice.proposal'
        raise RuntimeError(
            "Cannot reverse this migration. 'Invoice.proposal' and its values cannot be restored.")
