...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proposal.payment_delay'
        db.add_column('project_proposal', 'payment_delay', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Proposal.payment_delay_other'
        db.add_column('project_proposal', 'payment_delay_other', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Proposal.payment_delay_type_other'
        db.add_column('project_proposal', 'payment_delay_type_other', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Proposal.payment_delay'
        db.delete_column('project_proposal', 'payment_delay')

        # Deleting field 'Proposal.payment_delay_other'
        db.delete_column('project_proposal', 'payment_delay_other')

        # Deleting field 'Proposal.payment_delay_type_other'
        db.delete_column('project_proposal', 'payment_delay_type_other')
