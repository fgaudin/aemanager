...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.customer'
        db.add_column('project_invoice', 'customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contact.Contact'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Invoice.customer'
        db.delete_column('project_invoice', 'customer_id')
