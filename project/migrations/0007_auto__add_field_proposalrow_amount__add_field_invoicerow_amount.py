...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProposalRow.amount'
        db.add_column('project_proposalrow', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'InvoiceRow.amount'
        db.add_column('project_invoicerow', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'ProposalRow.amount'
        db.delete_column('project_proposalrow', 'amount')

        # Deleting field 'InvoiceRow.amount'
        db.delete_column('project_invoicerow', 'amount')
