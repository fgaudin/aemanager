...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proposal.footer_note'
        db.add_column('project_proposal', 'footer_note', self.gf('django.db.models.fields.CharField')(max_length=90, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Proposal.footer_note'
        db.delete_column('project_proposal', 'footer_note')
