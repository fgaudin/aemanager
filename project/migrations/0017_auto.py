...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Proposal', fields ['state']
        db.create_index('project_proposal', ['state'])

        # Adding index on 'Project', fields ['state']
        db.create_index('project_project', ['state'])


    def backwards(self, orm):
        
        # Removing index on 'Project', fields ['state']
        db.delete_index('project_project', ['state'])

        # Removing index on 'Proposal', fields ['state']
        db.delete_index('project_proposal', ['state'])
