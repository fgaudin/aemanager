...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Issue.last_comment_date'
        db.add_column('bugtracker_issue', 'last_comment_date', self.gf('django.db.models.fields.DateTimeField')(default='1970-01-01 00:00:00'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.last_comment_date'
        db.delete_column('bugtracker_issue', 'last_comment_date')
