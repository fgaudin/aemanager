...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for issue in orm['bugtracker.Issue'].objects.all():
            last_comment = issue.comment_set.all().aggregate(last_comment=Max('update_date'))
            issue.last_comment_date = last_comment['last_comment'] or issue.update_date
            issue.save()
