...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Subscription', fields ['user']
        db.delete_unique('autoentrepreneur_subscription', ['user_id'])

        # Changing field 'Subscription.user'
        db.alter_column('autoentrepreneur_subscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Subscription.user'
        db.alter_column('autoentrepreneur_subscription', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'Subscription', fields ['user']
        db.create_unique('autoentrepreneur_subscription', ['user_id'])
