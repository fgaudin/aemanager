...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.vat_number'
        db.alter_column('autoentrepreneur_userprofile', 'vat_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):

        # Changing field 'UserProfile.vat_number'
        db.alter_column('autoentrepreneur_userprofile', 'vat_number', self.gf('django.db.models.fields.CharField')(max_length=20))
