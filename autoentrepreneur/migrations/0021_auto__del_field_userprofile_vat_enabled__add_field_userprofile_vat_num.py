...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.vat_enabled'
        db.delete_column('autoentrepreneur_userprofile', 'vat_enabled')

        # Adding field 'UserProfile.vat_number'
        db.add_column('autoentrepreneur_userprofile', 'vat_number', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)


    def backwards(self, orm):

        # Adding field 'UserProfile.vat_enabled'
        db.add_column('autoentrepreneur_userprofile', 'vat_enabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'UserProfile.vat_number'
        db.delete_column('autoentrepreneur_userprofile', 'vat_number')
    ...
    models = {
        ...
        'autoentrepreneur.userprofile': {
            ...
            'vat_number': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'})
        },
        'contact.address': {
