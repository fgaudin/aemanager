...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('autoentrepreneur_userprofile', 'phonenumber', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'UserProfile.professional_email'
        db.add_column('autoentrepreneur_userprofile', 'professional_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.phonenumber'
        db.delete_column('autoentrepreneur_userprofile', 'phonenumber')

        # Deleting field 'UserProfile.professional_email'
        db.delete_column('autoentrepreneur_userprofile', 'professional_email')
