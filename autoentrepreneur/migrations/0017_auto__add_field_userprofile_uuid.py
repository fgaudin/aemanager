...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('autoentrepreneur_userprofile', 'uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=36), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'UserProfile.uuid'
        db.delete_column('autoentrepreneur_userprofile', 'uuid')
