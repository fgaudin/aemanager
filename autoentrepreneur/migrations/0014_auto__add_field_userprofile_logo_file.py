...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.logo_file'
        db.add_column('autoentrepreneur_userprofile', 'logo_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.logo_file'
        db.delete_column('autoentrepreneur_userprofile', 'logo_file')
