...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SalesLimit'
        db.create_table('autoentrepreneur_saleslimit', (
            ...
            ('limit2', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('autoentrepreneur', ['SalesLimit'])


    def backwards(self, orm):
        
        # Deleting model 'SalesLimit'
        db.delete_table('autoentrepreneur_saleslimit')
