...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.bank_information'
        db.delete_column('autoentrepreneur_userprofile', 'bank_information')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.bank_information'
        db.add_column('autoentrepreneur_userprofile', 'bank_information', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
