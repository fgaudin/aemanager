...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.professional_category'
        db.add_column('autoentrepreneur_userprofile', 'professional_category', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.professional_category'
        db.delete_column('autoentrepreneur_userprofile', 'professional_category')
