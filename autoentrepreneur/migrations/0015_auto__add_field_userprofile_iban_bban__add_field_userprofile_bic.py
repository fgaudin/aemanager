...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.iban_bban'
        db.add_column('autoentrepreneur_userprofile', 'iban_bban', self.gf('django.db.models.fields.CharField')(default='', max_length=34, blank=True), keep_default=False)

        # Adding field 'UserProfile.bic'
        db.add_column('autoentrepreneur_userprofile', 'bic', self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.iban_bban'
        db.delete_column('autoentrepreneur_userprofile', 'iban_bban')

        # Deleting field 'UserProfile.bic'
        db.delete_column('autoentrepreneur_userprofile', 'bic')
    ...
    models = {
        ...
        'autoentrepreneur.userprofile': {
            ...
            'bic': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'blank': 'True'}),
