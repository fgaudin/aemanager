...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.unregister_datetime'
        db.add_column('autoentrepreneur_userprofile', 'unregister_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.unregister_datetime'
        db.delete_column('autoentrepreneur_userprofile', 'unregister_datetime')
