...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('autoentrepreneur_subscription', (
            ...
            ('transaction_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('autoentrepreneur', ['Subscription'])


    def backwards(self, orm):
        
        # Deleting model 'Subscription'
        db.delete_table('autoentrepreneur_subscription')
