...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Subscription', fields ['expiration_date']
        db.create_index('autoentrepreneur_subscription', ['expiration_date'])

        # Adding index on 'Subscription', fields ['state']
        db.create_index('autoentrepreneur_subscription', ['state'])


    def backwards(self, orm):
        
        # Removing index on 'Subscription', fields ['state']
        db.delete_index('autoentrepreneur_subscription', ['state'])

        # Removing index on 'Subscription', fields ['expiration_date']
        db.delete_index('autoentrepreneur_subscription', ['expiration_date'])
