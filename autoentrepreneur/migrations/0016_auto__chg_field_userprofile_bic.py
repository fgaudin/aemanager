...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.bic'
        db.alter_column('autoentrepreneur_userprofile', 'bic', self.gf('django.db.models.fields.CharField')(max_length=11))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.bic'
        db.alter_column('autoentrepreneur_userprofile', 'bic', self.gf('django.db.models.fields.CharField')(max_length=1))
