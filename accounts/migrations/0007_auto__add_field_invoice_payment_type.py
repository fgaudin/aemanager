...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.payment_type'
        db.add_column('accounts_invoice', 'payment_type', self.gf('django.db.models.fields.IntegerField')(default=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.payment_type'
        db.delete_column('accounts_invoice', 'payment_type')
