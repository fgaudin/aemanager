...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvoiceRow.proposal'
        db.alter_column('accounts_invoicerow', 'proposal_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.Proposal']))


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'InvoiceRow.proposal'
        raise RuntimeError("Cannot reverse this migration. 'InvoiceRow.proposal' and its values cannot be restored.")
