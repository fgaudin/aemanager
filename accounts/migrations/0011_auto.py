...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Expense', fields ['date']
        db.create_index('accounts_expense', ['date'])

        # Adding index on 'Invoice', fields ['payment_date']
        db.create_index('accounts_invoice', ['payment_date'])

        # Adding index on 'Invoice', fields ['state']
        db.create_index('accounts_invoice', ['state'])

        # Adding index on 'Invoice', fields ['paid_date']
        db.create_index('accounts_invoice', ['paid_date'])

        # Adding index on 'Invoice', fields ['edition_date']
        db.create_index('accounts_invoice', ['edition_date'])


    def backwards(self, orm):
        
        # Removing index on 'Invoice', fields ['edition_date']
        db.delete_index('accounts_invoice', ['edition_date'])

        # Removing index on 'Invoice', fields ['paid_date']
        db.delete_index('accounts_invoice', ['paid_date'])

        # Removing index on 'Invoice', fields ['state']
        db.delete_index('accounts_invoice', ['state'])

        # Removing index on 'Invoice', fields ['payment_date']
        db.delete_index('accounts_invoice', ['payment_date'])

        # Removing index on 'Expense', fields ['date']
        db.delete_index('accounts_expense', ['date'])
