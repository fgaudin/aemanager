...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_invoicerow', (
            ...
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoice_rows', to=orm['accounts.Invoice'])),
        ...
        db.send_create_signal('accounts', ['InvoiceRow'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounts_invoicerow')
