    ...
    def forwards(self, orm):
        ...
        for invoice in orm.Invoice.objects.all():
            if not invoice.payment_date:
                invoice.payment_date = invoice.edition_date
                invoice.save()

        # Changing field 'Invoice.payment_date'
        db.alter_column('accounts_invoice', 'payment_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Invoice.payment_date'
        db.alter_column('accounts_invoice', 'payment_date', self.gf('django.db.models.fields.DateField')(null=True))
