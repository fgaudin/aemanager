...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.footer_note'
        db.add_column('accounts_invoice', 'footer_note', self.gf('django.db.models.fields.CharField')(max_length=90, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Invoice.footer_note'
        db.delete_column('accounts_invoice', 'footer_note')
