...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvoiceRow.quantity'
        db.alter_column('accounts_invoicerow', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))


    def backwards(self, orm):

        # Changing field 'InvoiceRow.quantity'
        db.alter_column('accounts_invoicerow', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))
