...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RestoreRequest.backup_file'
        db.add_column('backup_restorerequest', 'backup_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RestoreRequest.backup_file'
        db.delete_column('backup_restorerequest', 'backup_file')
